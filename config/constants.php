...
return [
    ...
    */
    ...
    'partners_img_bucket' => env('PARTNERS_IMG_BUCKET'),
    'applicationUsers_img_bucket' => env('APPLICATION_USERS_IMG_BUCKET'),
    'partners_invoices_bucket' => env('PARTNERS_INVOICES_BUCKET'),
    'applicationUsers_invoices_bucket' => env('APPLICATION_USERS_INVOICES_BUCKET'),
    'trash_bucket' => env('TRASH_BUCKET'),
