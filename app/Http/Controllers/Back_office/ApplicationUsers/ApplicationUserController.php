...
class ApplicationUserController extends Controller
{
    ...
    )
    {
        ...
        if (isset($applicationUser->picture) && !empty($applicationUser->picture)) {
            $picture_url = Storage::disk('gcs')->url(Config::get('constants.applicationUsers_img_bucket') . $applicationUser->picture);
        }

        return view('applicationUsers.show', compact('applicationUser', 'picture_url'));
    }
    ...
    )
    {
        ...
        return view('applicationUsers.edit', compact('applicationUser', 'picture_url'));
    }
